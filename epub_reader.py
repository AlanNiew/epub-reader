...
class EPUBReader(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.reader_top = QWidget()
        top_layout = QHBoxLayout(self.reader_top)
        top_layout.setContentsMargins(12, 6, 12, 6)
        self.back_btn = QPushButton('< 返回书架')
        self.back_btn.clicked.connect(self.show_bookshelf)
        top_layout.addWidget(self.back_btn)
        self.reader_title = QLabel('')
        self.reader_title.setStyleSheet('font-size: 14px; font-weight: bold;')
        top_layout.addWidget(self.reader_title, 1)
        reader_outer.addWidget(self.reader_top)
    ...
    def load_epub(self, file_path):
        try:
            ...
            self.reader_title.setText(self.book_title)
